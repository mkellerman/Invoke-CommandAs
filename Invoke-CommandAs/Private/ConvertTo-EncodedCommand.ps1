...
PowerSploit Function: Out-EncodedCommand (Renamed)
...
C:\PS> ConvertTo-EncodedCommand -ScriptBlock {Write-Host 'hello, world!'}
...
C:\PS> ConvertTo-EncodedCommand -Path C:\EvilPayload.ps1 -NonInteractive -NoProfile -WindowStyle Hidden -EncodedOutput
